        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          {role === 'TENANT' && tenant && (
            <div className="rounded-2xl border border-border bg-background p-6 lg:col-span-2">
              ...
              <div className="grid gap-x-8 gap-y-3 text-sm sm:grid-cols-2">
                <Row label="KYC Status" value={String(tenant.kycStatus).replace('_', ' ')} />
                <Row label="Screening Band" value={tenant.screeningBand} />
                <Row label="Date of Birth" value={tenant.dateOfBirth} />
                <Row label="Marital Status" value={tenant.maritalStatus} />
                <Row label="Employment Status" value={tenant.employmentStatus} />
                <Row label="Employer" value={tenant.employerName} />
                <Row label="Job Title" value={tenant.jobTitle} />
                <Row label="Monthly Income" value={tenant.monthlyIncome} />
                <Row label="ID Type" value={tenant.nationalIdType} />
                ...
                <Row label="Onboarded" value={tenant.isOnboarded ? 'Yes' : 'No'} />
              </div>
