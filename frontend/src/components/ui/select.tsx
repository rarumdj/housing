...
import { ChevronDown, Check, ChevronUp } from '@untitledui/icons';
...
const SelectItem = ({ className, children, ...props }: SelectPrimitive.Item.Props) => {
  return (
    <SelectPrimitive.Item
      ...
      {...props}
    >
      <SelectPrimitive.ItemText className="flex flex-1 gap-2 shrink-0 backgroundspace-nowrap">
        {children}
