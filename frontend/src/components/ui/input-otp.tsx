...
const InputOTPGroup = ({ className, ...props }: React.ComponentProps<'div'>) => {
  return (
    <div
      ...
      className={cn('rounded-lg flex items-center', className)}
      {...props}
    />
  );
};
