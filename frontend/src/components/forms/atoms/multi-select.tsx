...
import { Check, XCircle, ChevronDown, XClose, MagicWand01 } from '@untitledui/icons';
                      ...
                      return (
                        <Badge
                          ...
                          className={cn(
                            ...
                            customStyle?.gradient && 'text-background border-transparent',
                            responsiveSettings.compactMode && 'text-xs px-1.5 py-0.5',
                            screenSize === 'mobile' && 'max-w-[120px] truncate',
                            singleLine && 'shrink-0 backgroundspace-nowrap',
                        ...
                        >
                          ...
                          <div
                            ...
                            className="ml-2 size-4 cursor-pointer hover:bg-background/20 rounded-sm p-0.5 -m-0.5 focus:outline-none focus:ring-1 focus:ring-background/50"
                          >
                            <XCircle
                              className={cn(
                                'size-3',
                  ...
                  {selectedValues.length > responsiveSettings.maxCount && (
                    <Badge
                      className={cn(
                        ...
                        multiSelectVariants({ variant }),
                        responsiveSettings.compactMode && 'text-xs px-1.5 py-0.5',
                        singleLine && 'flex-shrink-0 backgroundspace-nowrap',
                        '[&>svg]:pointer-events-auto'
                      )}
                      style={{
